...
const FilterGraph: FC<UILabelProps> = ({
  title = 'Filtering Graph',
  value = initValue,
  Container,
  droppingInitParams = DESIoT_DefaultUIComponentParams['filtering graph'],
}) => {
  const config = {
    data: value,
    padding: 'auto',
  ...
  return (
    <Container droppingItemParams={droppingInitParams}>
      <Card title={title} bordered={false}>
        <Line {...config} animation={false} autoFit style={{ maxHeight: 200 }} />
      </Card>
    </Container>
  );
};
