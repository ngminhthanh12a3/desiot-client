    ...
    // },
    {
      ...
      routes: [
        ...
        },
        {
          name: 'profile',
          icon: 'smile',
          path: '/configuration/:config_id',
          component: './configuration/profile',
          hideInMenu: true,
          routes: [
            {
              path: '/configuration/:config_id',
              redirect: '/configuration/:config_id/device',
            },
            {
              name: 'device',
              icon: 'smile',
              path: '/configuration/:config_id/device',
              component: './configuration/profile/device',
              // hideInMenu: true,
            },
            {
              name: 'vstorage',
              icon: 'smile',
              path: '/configuration/:config_id/vstorage',
              component: './configuration/profile/vstorage',
              // hideInMenu: true,
            },
            {
              name: 'UI',
              icon: 'smile',
              path: '/configuration/:config_id/UI',
              component: './configuration/profile/UI',
              routes: [
                {
                  name: 'ReadOnlyUIDashboard',
                  icon: 'smile',
                  path: '/configuration/:config_id/UI/:ui_id',
                  component: './configuration/profile/UI/readOnlyUIDashboard',
                },
                {
                  name: 'EditableUIDashboard',
                  icon: 'smile',
                  path: '/configuration/:config_id/UI/:ui_id/edit',
                  component: './configuration/profile/UI/editableUIDashboard',
                },
              ],
            },
          ],
      ...
      routes: [
        {
          ...
          routes: [
            {
              path: '/device/:device_id',
              redirect: '/device/:device_id/UI',
            },
            {
              name: 'UI',
              icon: 'smile',
              path: '/device/:device_id/UI',
              component: './device/info/UI',
            },
          ],
        },
      ],
